...
def evaluate_body_particle_contact(
    ...
    return body_contact_force, body_contact_hessian, body_index, wp.spatial_vector(wp.cross(bx, -body_contact_force), -body_contact_force)
...
def accumulate_contact_force_and_hessian(
    ...
    if t_id < particle_body_contact_count:
        ...
        if particle_colors[particle_idx] == current_color:
            body_contact_force, body_contact_hessian, body_index, body_spatial_force = evaluate_body_particle_contact(
                particle_idx,
                pos[particle_idx],
