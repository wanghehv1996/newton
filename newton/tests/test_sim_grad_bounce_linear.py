...
class BallBounceLinearTest:
    def __init__(self, gravity=True, rendering=False):
        ...
        if gravity:
            ...
            builder = newton.ModelBuilder(gravity=0.0, up_vector=wp.vec3(0, 0, 1))
        ...
        self.integrator = newton.solvers.SemiImplicitIntegrator()
        if rendering:
    ...
    def generate_target_trajectory(self):
        for i in range(self.sim_steps):
            ...
            newton.collision.collide(self.model, curr_state)
