...
class Example:
    def __init__(self, viewer):
        ...
        # self.sim_vbd_iterations = 3
        #       body-cloth contact
        self.cloth_particle_radius = 0.002
        self.cloth_body_contact_margin = 0.003
        #       self-contact
        self.self_contact_radius = 0.002
        self.self_contact_margin = 0.003

        self.soft_contact_ke = 10
        ...
        [mesh_points, mesh_indices] = load_mesh(newton.examples.get_asset("shirt/blue/blue.obj"))
        cloth_scale = 1.0
